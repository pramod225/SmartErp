    ...
    if (ratingName == '') {
        ...
        $.post("/Masters/MasterEntries_Save", {
            ...
            if (data.Success == true) {
                $("#RatingList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
...
function SaveCompanySize() {
    ...
    if (companysize == '') {
        ...
        $.post("/Masters/MasterEntries_Save", {
            ...
            if (data.Success == true) {
                $("#CompanySizeList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
...
function SaveLossReason() {
    ...
    if (LossReason == '') {
        ...
        $.post("/Masters/MasterEntries_Save", {
            ...
            if (data.Success == true) {
                $("#LossReasonList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
...
function SaveCampaignSource() {
    ...
    if (CampaignSourceName == '') {
        ...
        $.post("/Masters/MasterEntries_Save", {
            ...
            if (data.Success == true) {
                $("#CampaignSourceList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
...
function SaveCountry() {
    ...
    if (countryName == '') {
        ...
        $.post("/Masters/Countries_Save", {
            ...
            if (data.Success == true) {
                $("#CountriesList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
...
function IndustrySave() {
    ...
    if (industryName == '') {
        ...
        $.post("/Masters/MasterEntries_Save", {
            ...
            if (data.Success == true) {
                $("#IndustriesList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
...
function SaveStage() {
    ...
    if (StageName == '') {
        ...
        $.post("/Masters/MasterEntries_Save", {
            ...
            if (data.Success == true) {
                $("#StageList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
...
function SaveOpportunityType() {
    ...
    if (opportunityName == '') {
        ...
        $.post("/Masters/MasterEntries_Save", {
            ...
            if (data.Success == true) {
                $("#OpportunityTypeList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
...
function SaveLeadSource() {
    ...
    if (LeadName == '') {
        ...
        $.post("/Masters/MasterEntries_Save", {
            ...
            if (data.Success == true) {
                $("#LeadSourceList").data("kendoGrid").dataSource.read();
            }
            else {
                alert(data.Message);
            }
